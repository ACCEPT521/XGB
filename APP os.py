...
# Paths
# -----------------------------
APP_DIR = Path(r"D:\4.毕业论文相关\数据重整-12-31\4月\部署代码-XGB")
...
if not MODEL_PATH.exists():
    ...
    st.info("请先运行 build_deploy_resources.py，生成 deploy_resources/xgb_topk6_deploy_res.joblib")
    st.stop()
